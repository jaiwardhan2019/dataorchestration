		...
		{
			return DrawHTMLBarcode_Code39(data,checkDigit,"yes","in", 0,1,.3,3,"bottom","left", "","black","white"); 
		}
						    ...
						    mode)
		{
			  ...
			  if (mode=="html")
			  {
				  ...
				  {
					if (textStyle=='')
						humanSpan='<span style="font-family : arial; font-size:9pt">'+humanReadableText+'</span><br />';
					else
			  ...
			  if (mode=="html")
			  {
				  ...
				  {
					if (textStyle=='')
						humanSpan='<br /><span style="font-family : arial; font-size:9pt">'+humanReadableText+'</span>';
					else
