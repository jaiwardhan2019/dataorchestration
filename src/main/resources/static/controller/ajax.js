...
function add_InvoiceItem()
{
	...
	var mfg = document.getElementById("mfg").value;		// Set variables. Get them by their ID
	...
	var packing_type = document.getElementById("packing_type").value;		// Set variables. Get them by their ID
		packing_type = packing_type.replace(/;/g, "SEMCO");
		packing_type = packing_type.replace(/&/g, "ampSNT");
		
	var batch = document.getElementById("batch").value;		// Set variables. Get them by their ID
		batch = batch.replace(/;/g, "SEMCO");
		batch = batch.replace(/&/g, "ampSNT");
	
	var exp = document.getElementById("exp").value;		// Set variables. Get them by their ID
		exp = exp.replace(/;/g, "SEMCO");
		exp = exp.replace(/&/g, "ampSNT");
		
	var hsn = document.getElementById("hsn").value;		// Set variables. Get them by their ID
		hsn = hsn.replace(/;/g, "SEMCO");
		hsn = hsn.replace(/&/g, "ampSNT");
		
	var lot = (document.getElementById("approx_lot").value -0);		// Set variables. Get them by their ID
	var pack_of = (document.getElementById("pack_of").value -0);		// Set variables. Get them by their ID
	var total_quantity = (document.getElementById("total_quantity").value -0);		// Set variables. Get them by their ID
	
	var sale_lot = (document.getElementById("sale_lot").value -0);		// Set variables. Get them by their ID
	var sale_pcs = (document.getElementById("sale_pcs").value -0);		// Set variables. Get them by their ID
	
	var free = (document.getElementById("free").value -0);		// Set variables. Get them by their ID
	var sale_total_qty = (sale_lot * pack_of) + free;
	
	var sale_price = (document.getElementById("sale_price").value -0);		// Set variables. Get them by their ID
	var rate = (document.getElementById("rate").value -0);		// Set variables. Get them by their ID
	var mrp = (document.getElementById("mrp").value -0);		// Set variables. Get them by their ID
	var discount = (document.getElementById("discount").value -0);		// Set variables. Get them by their ID
	var margin = (document.getElementById("margin").value -0);		// Set variables. Get them by their ID
	var gst = document.getElementById("gst").value;		// Set variables. Get them by their ID
	var purchase_gst_amount = (document.getElementById("purchase_gst_amount").value -0);		// Set variables. Get them by their ID
	var weight = document.getElementById("weight").value;		// Set variables. Get them by their ID
	
	var product_id = document.getElementById("product_id").value;		// Set variables. Get them by their ID
	var i = document.getElementById("invoice_id").value;		// Set variables. Get them by their ID

//--- Validation
if (product_id == null || product_id == "" || product_id == " ")
	{
		document.getElementById("warning_item_description").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> Must enter an Item</font>";
		return false;
	}
else
	{
...
if (item == null || item == "" || item == " ")
	{
		document.getElementById("warning_item_description").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i></font>";
		return false;
	}
else
	{
...
if (type == null || type == "" || type == " ")
	{
		document.getElementById("warning_item_type").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i></font>";
		return false;
	}
else
	{
		document.getElementById("warning_item_type").innerHTML = " ";
	}
	
if (batch == null || batch == "" || batch == " ")
	{
		document.getElementById("warning_item_batch").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i></font>";
		return false;
	}
else
	{
		document.getElementById("warning_item_batch").innerHTML = " ";
	}
	
if (hsn == null || hsn == "" || hsn == " ")
	{
		document.getElementById("warning_item_hsn").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i></font>";
		return false;
	}
else
	{
		document.getElementById("warning_item_hsn").innerHTML = " ";
	}

if (lot == null || lot == "" || lot == " ")
	{
		document.getElementById("warning_lot_quantity").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> Approx. lot</font>";
		return false;
	}
else
	{
...
if (pack_of == null || pack_of == "" || pack_of == " " || pack_of == 0)
	{
		document.getElementById("warning_pack_of_quantity").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> Pack of</font>";
		return false;
	}
else
	{
		document.getElementById("warning_pack_of_quantity").innerHTML = " ";
	}
...
if (sale_lot == 0 && sale_pcs == 0)
	{
		document.getElementById("warning_sale_qty").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> Selling lot. </font>";
		return false;
	}
else
	{
		document.getElementById("warning_sale_qty").innerHTML = " ";
	}
	
if (margin == 0)
	{
		document.getElementById("warning_sale_margin").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> Retailer margin. </font>";
		return false;
	}
else
	{
		document.getElementById("warning_sale_margin").innerHTML = " ";
	}

if (sale_lot > lot)
	{
		document.getElementById("item_message_flash").innerHTML = "<br /><div class='alert alert-danger' style='font-size:9pt;'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button><i class='fa fa-exclamation-triangle'></i> <strong>Low stock!</strong> Your current product stock is less than ordered. Please order less or equal amount to proceed.</div>";
		return false;
	}
else
	{
...
if (sale_total_qty > total_quantity)
	{
		document.getElementById("item_message_flash").innerHTML = "<br /><div class='alert alert-danger' style='font-size:9pt;'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button><i class='fa fa-exclamation-triangle'></i> <strong>Low stock!</strong> Your current product stock is less than ordered. Please order less or equal amount to proceed.</div>";
		return false;
	}
				...
				if(data == 1)
					{
						...
						document.getElementById("mfg").placeholder = "MFG";
						
						document.getElementById("type").value = "";
						document.getElementById("type").placeholder = "Type";
						
						document.getElementById("packing_type").value = "";
						document.getElementById("packing_type").placeholder = "Type";
						
						document.getElementById("batch").value = "";
						document.getElementById("batch").placeholder = "Batch";
						
						document.getElementById("exp").value = "";
						document.getElementById("exp").placeholder = "Expiry";
						
						document.getElementById("hsn").value = "";
						document.getElementById("hsn").placeholder = "HSN Code";
						
						document.getElementById("approx_lot").value = "";
						document.getElementById("approx_lot").placeholder = "Qty";
						
						document.getElementById("pack_of").value = "";
						document.getElementById("pack_of").placeholder = "Qty";
						
						document.getElementById("total_quantity").value = "";
						document.getElementById("total_quantity").placeholder = "Stock";
						
						document.getElementById("free").value = "";
						document.getElementById("free").placeholder = "Free";
						
						document.getElementById("rate").value = "";
						document.getElementById("rate").placeholder = "Each (Rs.)";
						
						document.getElementById("mrp").value = "";
						document.getElementById("mrp").placeholder = "Each (Rs.)";
						...
						document.getElementById("sale_pcs").value = "";
						document.getElementById("sale_pcs").placeholder = "Pcs";
						
						document.getElementById("sale_price").value = "";
						document.getElementById("sale_price").placeholder = "Sale Price";
						
						document.getElementById("margin").value = "";
						document.getElementById("margin").placeholder = "(%)";
						
						document.getElementById("weight").value = "";
						document.getElementById("weight").placeholder = "(Gms.)";
...
function refresh_invoiceItem()
{
    ...
    xmlhttp.onreadystatechange = function() 
		...
		xmlhttp.open("GET","ui/ajax/invoiceItems_refresh.php?invoice_id="+id+"&"+rnd,true);
		xmlhttp.send();
}
...
function finalizeInward()
{
	...
	var invoice_id = document.getElementById("invoice_id").value;		// Set variables. Get them by their ID
	...
	var al = "invoice.php?invoice_id="+invoice_id;
...
//--Ends here 
	...
	$.ajax({
	  ...
	  success: function(data)
	  {
		if(data == 1)
			{	
				document.getElementById("added_message").innerHTML = "<div class='alert alert-success' style='font-size:9pt;'><button type='button' class='close' data-dismiss='alert' aria-label='Close'><span aria-hidden='true'>&times;</span></button><strong>Success! </strong>party ceated successfully.</div>";
				location.href = al; //--refresh
			}
		else
			{
...
function add_PurchaseItem()
{
	...
	var discount = (document.getElementById("discount").value -0);		// Set variables. Get them by their ID
	var gst = document.getElementById("gst").value;		// Set variables. Get them by their ID
	var gst_type = document.getElementById("gst_type").value;		// Set variables. Get them by their ID
	
	var weight = document.getElementById("weight").value;		// Set variables. Get them by their ID
	var base_margin = document.getElementById("margin").value;		// Set variables. Get them by their ID
	
	var i = document.getElementById("purchase_id").value;		// Set variables. Get them by their ID
...
if (mfg == null || mfg == "" || mfg == " ")
	{
		document.getElementById("warning_item_description").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> MFG?</font>";
		return false;
	}
else
	{
...
if (exp == null || exp == "" || exp == " ")
	{
		//document.getElementById("warning_item_description").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> Expiry date/month/year?</font>";
		//return false;
	}
else
	{
...
if (type == null || type == "" || type == " ")
	{
		document.getElementById("warning_item_type").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> Type?</font>";
		return false;
	}
else
	{
...
if (batch == null || batch == "" || batch == " ")
	{
		//document.getElementById("warning_item_batch").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> Batch?</font>";
		//return false;
	}
else
	{
...
if (gst == null || gst == "" || gst == " ")
	{
		document.getElementById("warning_gst").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> GST?</font>";
		return false;
	}
else
	{
		document.getElementById("warning_gst").innerHTML = " ";
	}

if (gst_type == null || gst_type == "" || gst_type == " " || gst_type != "I" && gst_type != "SC" && gst_type != "NON")
	{
		document.getElementById("warning_gst").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> IGST or CGST/SGCT? Type I for IGST, SC for CGST/SGCT.</font>";
		return false;
	}
else
	{
...
if (mrp == null || mrp == "" || mrp == " ")
	{
		document.getElementById("warning_mrp").innerHTML = "<br /><font style='color:#ff6666;'><i class='fa fa-exclamation-triangle'></i> MRP?</font>";
		return false;
	}
else
	{
		document.getElementById("warning_mrp").innerHTML = " ";
	}
				...
				if(data == 1)
					{
						...
						document.getElementById("mfg").value = "";
						document.getElementById("mfg").placeholder = "Manufacturer";
						document.getElementById("exp").value = "";
						document.getElementById("exp").placeholder = "Expiry";
						document.getElementById("type").value = "";
						document.getElementById("type").placeholder = "Type";
						document.getElementById("packing_type").value = "";
						document.getElementById("packing_type").placeholder = "Packing Type";
						document.getElementById("batch").value = "";
						document.getElementById("batch").placeholder = "Batch";
						document.getElementById("hsn").value = "";
						document.getElementById("hsn").placeholder = "HSN Code";
						...
						document.getElementById("gst_type").placeholder = "I / SC";
						
						document.getElementById("mrp").value = "";
						document.getElementById("mrp").placeholder = "MRP (Rs.)";
...
function refresh_purchaseItem()
{
	...
	xmlhttp.open("GET","ui/ajax/purchaseItems_refresh.php?purchase_id="+id+"&"+rnd,true);
	xmlhttp.send();
}
...
function finalizePurchase()
{
	...
	var memo_id = document.getElementById("memo_number").value;		// Set variables. Get them by their ID
	...
	var purchase_id = document.getElementById("purchase_id").value;		// Set variables. Get them by their ID
	var purchase_date = document.getElementById("purchase_date").value;		// Set variables. Get them by their ID
	var receiving_date = document.getElementById("receiving_date").value;		// Set variables. Get them by their ID
	var packet_items_count = document.getElementById("packet_items_count").value;		// Set variables. Get them by their ID
	var gross_amount = document.getElementById("gross_amount").value;		// Set variables. Get them by their ID
	...
	var al = "purchase.php?party_id="+party_id+"&purchase_id="+purchase_id;
//--- Validation
if (name == null || name == "" || name == " ")
	{
