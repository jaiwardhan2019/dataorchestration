...
//--Ends here 
    ...
    xmlhttp.onreadystatechange = function() 
		...
		xmlhttp.open("GET","ui/ajax/autosuggest_Product_Purchase.php?product="+product+"&"+rnd,true);
		xmlhttp.send();
}
...
//--Ends here 
    ...
    xmlhttp.onreadystatechange = function() 
		...
		xmlhttp.open("GET","ui/ajax/autosuggest_Product_Add.php?product="+product+"&"+rnd,true);
		xmlhttp.send();
}
...
{
	document.getElementById("fireTypeDropdown").click();
}
...
//--Ends here 
    ...
    xmlhttp.onreadystatechange = function() 
		...
		xmlhttp.open("GET","ui/ajax/autosuggest_Type.php?type="+type+"&"+rnd,true);
		xmlhttp.send();
}
...
{
	document.getElementById("fireProductDropdown").click();
}
...
//--Ends here 
    ...
    xmlhttp.onreadystatechange = function() 
		...
		xmlhttp.open("GET","ui/ajax/autosuggest_Product_Sale.php?product="+product+"&"+rnd,true);
		xmlhttp.send();
}
